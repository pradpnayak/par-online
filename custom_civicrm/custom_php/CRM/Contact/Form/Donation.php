...
class CRM_Contact_Form_Donation extends CRM_Core_Form {
    ...
    static function saveContribution(){
        ...
        $monerisParams['first_name']     = $contactResult['values'][$contactResult['id']]['first_name'];
        $monerisParams['middle_name']    = $contactResult['values'][$contactResult['id']]['middle_name'];
        $monerisParams['last_name']      = $contactResult['values'][$contactResult['id']]['last_name'];
        $monerisParams['street_address'] = $addressResult['values'][$addressResult['id']]['street_address'];
        $monerisParams['city']           = $addressResult['values'][$addressResult['id']]['city'];
        $monerisParams['province']       = $addressResult['values'][$addressResult['id']]['state_province_id'];
        $monerisParams['country']        = $addressResult['values'][$addressResult['id']]['country_id'];  
        $monerisParams['postal_code']    = $addressResult['values'][$addressResult['id']]['postal_code'];
        $monerisParams['email']          = $emailResult['values'][$emailResult['id']]['email'];
        ...
        if ( $fieldDetails[ 'payment_instrument' ] != 1 ) {
            $paymentProcessor = new CRM_Core_Payment_DirectDebit();
            ...
            foreach( $bankDetails as $bankKey => $bankValue ) {
                $params[$bankValue] = $fieldDetails[$bankKey];
            }
