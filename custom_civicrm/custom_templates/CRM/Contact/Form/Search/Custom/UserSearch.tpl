...
<div class="crm-accordion-wrapper crm-custom_search_form-accordion {if $rows}crm-accordion-closed{else}crm-accordion-open{/if}">
    <div class="crm-accordion-header crm-master-accordion-header">
      ...
      {ts}Enter Search Criteria{/ts}
    </div><!-- /.crm-accordion-header -->
    <div class="crm-accordion-body">
    {if $tplFile eq 'CRM/Contact/Form/Search/Custom/ChargeSearch.tpl' || $tplFile eq 'CRM/Contact/Form/Search/Custom/UserSearch.tpl' || $tplFile eq 'CRM/Contact/Form/Search/Custom/LocalAdminUserSearch.tpl' }
	    ...
	    {foreach from=$elements item=element}
                    ...
                    <td class="label">{$form.$element.html}</td>
                    {if $element eq 'start_date'}
                        <td>{include file="CRM/common/jcalendar.tpl" elementName=start_date}</td>
                    {elseif $element eq 'end_date'}
                        <td>{include file="CRM/common/jcalendar.tpl" elementName=end_date}</td>
