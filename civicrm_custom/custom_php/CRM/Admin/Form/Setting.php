...
class CRM_Admin_Form_Setting extends CRM_Core_Form {
  ...
  public function buildQuickForm($check = FALSE) {
    ...
    $this->addElement('text', 'search_autocomplete_count', ts('Autocomplete Results'),
...
";
    ...
    if (CRM_Utils_Array::value('search_autocomplete_count', $params)) {
      require_once 'CRM/Core/BAO/Setting.php';
      CRM_Core_BAO_Setting::setItem($params['search_autocomplete_count'],
        CRM_Core_BAO_Setting::SYSTEM_PREFERENCES_NAME,
