...
class CRM_Contact_BAO_Relationship extends CRM_Contact_DAO_Relationship 
{
    ...
    static function setIsActive( $id, $is_active ) 
    {
        ...
        $result = CRM_Core_DAO::setFieldValue( 'CRM_Contact_DAO_Relationship', $id, 'is_active', $is_active );
        if (!$is_active) {
          CRM_Core_DAO::setFieldValue('CRM_Contact_DAO_Relationship', $id, 'end_date', date('Ymd'));
        }
