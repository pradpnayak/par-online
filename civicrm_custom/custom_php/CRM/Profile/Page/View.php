        ...
        if ($this->_gid) {
            ...
            if ( CRM_Core_Permission::ufGroupValid( $this->_gid,
                ...
                if ( CRM_Contact_BAO_GroupContact::isContactInGroup( $_SESSION[ 'CiviCRM' ][ 'userID' ], DENOMINATION_ADMIN_GROUP_ID ) ) {
                    $this->assign( 'listingURL', CRM_Utils_System::url( 'civicrm/contact/search/custom',"reset=1&csid=16&force=1") );
                }
                else if ( CRM_Contact_BAO_GroupContact::isContactInGroup( $_SESSION[ 'CiviCRM' ][ 'userID' ], PAR_ADMIN_GROUP_ID ) ) {
                    $this->assign( 'listingURL',  CRM_Utils_System::url( 'civicrm/contact/search/custom',"reset=1&csid=18&force=1") );
                }
            }
        } else {
            require_once 'CRM/Core/BAO/UFGroup.php';
