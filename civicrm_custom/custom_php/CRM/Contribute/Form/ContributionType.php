...
class CRM_Contribute_Form_ContributionType extends CRM_Contribute_Form
{
    ...
    public function buildQuickForm( ) 
    {
        ...
        $dataURL = CRM_Utils_System::url( 'civicrm/ajax/rest', 'className=CRM_Contact_Page_AJAX&fnName=getContactList&json=1&context=contact&org=1&pc=1', false, null, false );
        $this->assign('dataURL', $dataURL );
        $dataURLParentID = CRM_Utils_System::url( 'civicrm/ajax/rest', 'className=CRM_Contribute_Page_AJAX&fnName=contributionType&json=1', false, null, false );
        ...
        $this->add('text', 'organization_name', ts('Organization Name'), CRM_Core_DAO::getAttribute( 'CRM_Contribute_DAO_ContributionType', 'organization_name' ) );
        $this->add('hidden', 'contact_id', '', array( 'id' => 'contact_id' ) );
        
        $this->add('text', 'parent_contribution_type', ts('Parent Contribution Type'), CRM_Core_DAO::getAttribute( 'CRM_Contribute_DAO_ContributionType', 'parent_contribution_type' ) );
