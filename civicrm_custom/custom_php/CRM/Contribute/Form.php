...
class CRM_Contribute_Form extends CRM_Core_Form
{
    ...
    function setDefaultValues( ) {
        ...
        if ($this->_action == CRM_Core_Action::DELETE) {
            ...
            $organizationId = CRM_Core_DAO::getFieldValue( 'CRM_Contribute_DAO_ContributionType', $this->_id, 'contact_id' );
            $this->assign('organizationId', $organizationId );       
            $parentId = CRM_Core_DAO::getFieldValue( 'CRM_Contribute_DAO_ContributionType', $this->_id, 'parent_id' );
