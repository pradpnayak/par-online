...
class CRM_Contribute_DAO_ContributionType extends CRM_Core_DAO
{
    ...
    /**
     * pseudo FK into civicrm_contact.
     *
     * @var int unsigned
     */
    public $contact_id;
    /**
     * pseudo FK into civicrm_contribution_type.
     *
     * @var int unsigned
     */
    public $parent_id;
    ...
    function &fields()
    {
        if (!(self::$_fields)) {
            self::$_fields = array(
                ...
                'contribution_type_contact_id' => array(
                    'name' => 'contact_id',
                    'type' => CRM_Utils_Type::T_INT,
                    'title' => ts('Contact ID') ,
                    'import' => true,
                    'where' => 'civicrm_contribution_type.contact_id',
                    'headerPattern' => '/contact(.?id)?/i',
                    'dataPattern' => '/^\d+$/',
                    'export' => true,
                    'FKClassName' => 'CRM_Contact_DAO_Contact',
                ) ,
                'contribution_type_parent_id' => array(
                    'name' => 'parent_id',
                    'type' => CRM_Utils_Type::T_INT,
                    'title' => ts('Parent ID') ,
                    'import' => true,
                    'where' => 'civicrm_contribution_type.parent_id',
                    'headerPattern' => '/parent(.?id)?/i',
                    'dataPattern' => '/^\d+$/',
                    'export' => true,
                    'FKClassName' => 'CRM_Contact_DAO_ContributionType',
                ) ,
                'description' => array(
                    'name' => 'description',
                    'type' => CRM_Utils_Type::T_STRING,
