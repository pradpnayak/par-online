...
<div class="crm-actions-ribbon">
        ...
        {assign var="showSummary" value=0}	
...
//modified to get a confirmation before changing a tab
...
function stopSpinner( ) {
 ...
 cj( function() {
     ...
     cj("#mainTabContainer").tabs({ selected: tabIndex, spinner: spinnerImage,cache: false, select: fixTabAbort, load: stopSpinner});
